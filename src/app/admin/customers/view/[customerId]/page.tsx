...
export default function ViewCustomerPage() {
  ...
  const selectedLogDayStats = useMemo(() => selectedLogDayWeightLog ? calculateBmiAndBmrForDay(selectedLogDayWeightLog.weight) : { bmi: null, bmr: null }, [selectedLogDayWeightLog, profile]);
                        ...
                        <Card>
                            <CardHeader><CardTitle className="flex items-center gap-2 text-lg"><HeartPulse className="h-5 w-5"/> Health Profile</CardTitle></CardHeader>
                             <CardContent className="grid grid-cols-2 gap-6">
                                ...
                                <DetailItem icon={Info} label="Food Preference" value={profile?.foodPreference} />
                                ...
                                <div className="col-span-2">
                                    <DetailItem icon={Info} label="Health Problems" value={profile?.healthProblems} />
                                </div>
                                <div className="col-span-2">
                                    <DetailItem icon={Info} label="Allergies" value={profile?.allergies} />
                                </div>
                            </CardContent>
                        </Card>
                    </div>
