...
export default function EditPartnerPage() {
        ...
        try {
            ...
            if (docSnap.exists()) {
                ...
                form.reset({
                 ...
                 toast({ variant: "destructive", title: "Not Found", description: "Partner not found." });
  ...
  const onSubmit = async (data: PartnerFormData) => {
    ...
    try {
        ...
        toast({ variant: "success", title: "Success", description: "Partner details updated successfully." });
        router.push("/admin/partners");

    } catch (error: any) {
        console.error("Error updating partner: ", error);
        toast({ variant: "destructive", title: "Error", description: `Could not update partner: ${error.message}` });
    } finally {
  ...
  const handleActivatePartner = async () => {
    ...
    try {
       await processPartner({
        ...
        toast({ variant: "destructive", title: "Error", description: `Could not activate partner: ${error.message}` });
        ...
        <div className="flex items-center justify-between">
            ...
            <div>
             ...
             {initialData?.paymentStatus === 'Failed' && (
                <Button onClick={handleActivatePartner} disabled={isActivating}>
