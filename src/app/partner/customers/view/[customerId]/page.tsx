...
import { collection, query, where, getDocs, doc, runTransaction, Timestamp, onSnapshot, orderBy, getDoc, updateDoc } from "firebase/firestore";
...
import { IndianRupee, MessageSquare, Ruler, Ban, NotebookText, Camera, Activity, TrendingUp, TrendingDown, Scale, Building, BrainCircuit, Flame, Wheat, Drumstick, Leaf } from "lucide-react";
