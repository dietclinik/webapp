    ...
    <SidebarProvider defaultOpen={false}>
      ...
      <SidebarInset>
        ...
        <footer className="hidden md:flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
            ...
            <p className="text-xs text-muted-foreground">App Developed By <a href="https://catchytechnologies.com" target="_blank" rel="noopener noreferrer" className="text-primary no-underline">Catchy Technologies</a></p>
            </nav>
        </footer>
      </SidebarInset>
