...
import { Home, Settings, ShieldAlert, Users, CreditCard, Video, IndianRupee, Bell, BookCopy } from 'lucide-react';
...
function PageAccessWrapper({ children }: { children: ReactNode }) {
    ...
    useEffect(() => {
        const checkAccess = async () => {
            ...
            const userWeight = planTierWeights[userTier] || 0;
            const requiredWeight = planTierWeights[rule.minTier] || 0;
